...
```
Given this graph, we can see that Gold IV is by far the highest division (as confirmed earlier) and that normal distribution is maintained fairly well, with more players in division IV of Diamond, Platinum, and Gold and division I of Bronze and Iron. The only exception is Silver, with a fairly even distribution of players among its divisions.
