...
Since Challenger has the lowest number of players of the three tiers and Grandmaster the highest number by design, it would be easier to compare role distribution by percentage of players than raw counts.
```{r fig.width=10}
PositionPercent <-
  TopRanksPositions %>%
