...
GameData %>% 
  ...
  geom_boxplot()
```
From these boxplots, we can see that the interquartile range of total games played gets smaller we go down the tiers. However, the total games played by a single player is highest in the Gold tier.
...
In general, a player's mean win rate increases as they move up tiers. Within a tier, the higher divisions generally have higher win rates. The exception to this is division III and IV in Platinum and Gold. As tiers Master and above effectively are only one tier, the division mean win rate is the mean win rate of the tier.
