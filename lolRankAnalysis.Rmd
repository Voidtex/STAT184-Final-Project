...
## Analysis of role
In League of Legends, players pick their primary and secondary position they want to play before queueing to find a game. There are 5 positions: Top, Jungle, Mid, Bottom, and Support. In general, players will stick to a certain position when climbing the ranks since it is easier to have one consistant playstyle. This section will look at positions for Master, Grandmaster, and Challenger tiers since that is the only data available.
...
```{r}
# Function that takes role and lane and determines position based on documentation
